...
import {
  ...
  getEditReimbursment,
  getDoctorsList,getReimServicesList,
...
//Doctors API
  ...
  const handleclick = (type) => {
    ...
    if (step === "0") {
      const ClinicalfilterData =ClinicalData && ClinicalData.filter(
      ...
      const PharmacyfilterData =PharmacyData && PharmacyData.data.filter(
        (data) => data.hospitalType === type
      );
  ...
  return (
    <>
              ...
              <div className="search-btn">
                <div className="input-group">
                  ...
                  <div className="input-group-append">
                    <button className="btn btn-secondary" type="button" onClick={()=>handleOnSearch()}>
                      ...
                      <Modal.Body>
                        <div class="container">
                          <Form.Group>
                            ...
                            <Form.Control as="select" multiple value={doctors} onChange={e => setDoctors([].slice.call(e.target.selectedOptions).map(item => item.value))}>
            ...
            >
              <div className="table-responsive">
                <table className="table">
                  ...
                  {ClinicalData && ClinicalData.data.map((item) => (
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a onClick={() =>handleChangePage(item)}>{item.name}</a>
                          </td>
                          <td>{item.address}</td>
                          <td>{item.area}</td>
                          <td>{item.contact}</td>
                    ...
                    PharmacyData.data.map((item) => (
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{item.referenceNumber}</td>
                          <td>
                            <a onClick={handleChangePage}>{item.name}</a>
                          </td>
                          <td>{item.address}</td>
                          <td>{item.area}</td>
                          <td>{item.contact}</td>
      ...
      {ClinicDataPage && <AdClinicData selectedrecord={selectedrecord} data={ClinicalData} handleBack={handleBack}/>}
    </>
  );
};
