...
import {EyeOutlined,VerticalAlignBottomOutlined,PlusOutlined,FilterOutlined} from '@ant-design/icons';
...
const handleClick = (type) =>{
  const premiumfilterData = PremiumListArray.filter((data)=>data.userPolicy.premiumPlan === type)
...
const premiumCSVData = () =>{
  ...
  if(premiumtableDataArray){
    premiumPoliciesData.push('Invoice No,Policy Holder,Policy Name, Premium Plan, Payment Received Date, Amount\n')
