...
const AdminComplaint = () => {
    ...
    const handleClick = (type) => {
        const ComplaintfilterData = complaintListArray.filter((data) => data.verifyStatus === type)
...
{hrcomplaintsDetailspage && <HrComplaintDetails  selectedRecord={selectedRecord} data={complaintListArray} handleBack={handleBack}/>}
